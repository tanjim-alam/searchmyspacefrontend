...
export const updateProject = asyncHandler(async (req, res, next) => {
    ...
    const updatedProject = await projectModel.findByIdAndUpdate(
        pid,
        {
            ...
            amenitiesContent: amenitiesContent || project.amenitiesContent,
            pricePlanContent: pricePlanContent || project.pricePlanContent,
            locationContent: locationContent || project.locationContent,
